...
<!-- UsageSnippet language="php" operationID="trackLead" method="post" path="/track/lead" -->
```php
...
<!-- UsageSnippet language="php" operationID="trackSale" method="post" path="/track/sale" -->
```php
declare(strict_types=1);
