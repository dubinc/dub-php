...
class Partners
{
    ...
    public function create(?Operations\CreatePartnerRequestBody $request = null, ?Options $options = null): Operations\CreatePartnerResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'createPartner', null, $this->sdkConfiguration->securitySource);
    ...
    public function createLink(?Operations\CreatePartnerLinkRequestBody $request = null, ?Options $options = null): Operations\CreatePartnerLinkResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($baseUrl, 'createPartnerLink', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function analytics(Operations\RetrievePartnerAnalyticsRequest $request, ?Options $options = null): Operations\RetrievePartnerAnalyticsResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'retrievePartnerAnalytics', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function updateSale(?Operations\UpdatePartnerSaleRequestBody $request = null, ?Options $options = null): Operations\UpdatePartnerSaleResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'updatePartnerSale', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function upsertLink(?Operations\UpsertPartnerLinkRequestBody $request = null, ?Options $options = null): Operations\UpsertPartnerLinkResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'upsertPartnerLink', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
