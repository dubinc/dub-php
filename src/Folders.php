...
class Folders
{
    ...
    public function create(?Operations\CreateFolderRequestBody $request = null, ?Options $options = null): Operations\CreateFolderResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'createFolder', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $id, ?Options $options = null): Operations\DeleteFolderResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'deleteFolder', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function list(?string $search = null, ?bool $includeLinkCount = null, ?float $page = null, ?float $pageSize = null, ?Options $options = null): Operations\ListFoldersResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'listFolders', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function update(string $id, ?Operations\UpdateFolderRequestBody $requestBody = null, ?Options $options = null): Operations\UpdateFolderResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'updateFolder', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
