...
class ListPartnersResponseBody
{
     ...
     *
     * @var \Dub\Models\Operations\NetworkStatus $networkStatus
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('networkStatus')]
    #[\Speakeasy\Serializer\Annotation\Type('\Dub\Models\Operations\NetworkStatus')]
     ...
     *
     * @var \Dub\Models\Operations\ListPartnersStatus $status
     */
     ...
     *
     * @var ?\Dub\Models\Operations\DefaultPayoutMethod $defaultPayoutMethod
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('defaultPayoutMethod')]
    #[\Speakeasy\Serializer\Annotation\Type('\Dub\Models\Operations\DefaultPayoutMethod|null')]
     ...
     *
     * @var ?array<\Dub\Models\Operations\Links> $links
     */
     ...
     *
     * @var ?array<\Dub\Models\Operations\Tags> $tags
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('tags')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Dub\Models\Operations\Tags>|null')]
     ...
     *
     * @var ?\Dub\Models\Operations\BannedReason $bannedReason
     */
    ...
    /**
     *
     * @var ?\Dub\Models\Operations\ReferralFormData $referralFormData
     */
     ...
     *
     * @var ?\Dub\Models\Operations\Application $application
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('application')]
    #[\Speakeasy\Serializer\Annotation\Type('\Dub\Models\Operations\Application|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('earningsPerClick')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?float $earningsPerClick = null;

    /**
     * Average lifetime value for each paying customer (`Total Revenue ÷ Total Conversions`)
     *
     * @var ?float $averageLifetimeValue
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('averageLifetimeValue')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?float $averageLifetimeValue = null;

    /**
     * Percentage of clicks that become leads (`Total Leads ÷ Total Clicks`)
     *
     * @var ?float $clickToLeadRate
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('clickToLeadRate')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?float $clickToLeadRate = null;

    /**
     * Percentage of clicks that convert to paying customers (`Total Conversions ÷ Total Clicks`)
     *
     * @var ?float $clickToConversionRate
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('clickToConversionRate')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?float $clickToConversionRate = null;

    /**
     * Percentage of leads that convert to paying customers (`Total Conversions ÷ Total Leads`)
     *
     * @var ?float $leadToConversionRate
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('leadToConversionRate')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?float $leadToConversionRate = null;

    /**
     * Return On Ad Spend (ROAS) (`Total Revenue ÷ Total Commissions`)
     *
     * @var ?float $returnOnAdSpend
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('returnOnAdSpend')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?float $returnOnAdSpend = null;
     ...
     * @param  string  $id
     * @param  string  $name
     * @param  \Dub\Models\Operations\NetworkStatus  $networkStatus
     * @param  string  $programId
     * @param  string  $partnerId
     * @param  string  $createdAt
     * @param  \Dub\Models\Operations\ListPartnersStatus  $status
     ...
     * @param  ?array<\Dub\Models\Operations\Tags>  $tags
     ...
     * @param  ?\Dub\Models\Operations\BannedReason  $bannedReason
     * @param  ?\Dub\Models\Operations\ReferralFormData  $referralFormData
     * @param  ?\Dub\Models\Operations\Application  $application
     * @param  ?float  $earningsPerClick
     * @param  ?float  $averageLifetimeValue
     * @param  ?float  $clickToLeadRate
     * @param  ?float  $clickToConversionRate
     * @param  ?float  $leadToConversionRate
     * @param  ?float  $returnOnAdSpend
    ...
    public function __construct(string $id, string $name, NetworkStatus $networkStatus, string $programId, string $partnerId, string $createdAt, ListPartnersStatus $status, ?string $username = null, ?string $email = null, ?string $image = null, ?string $country = null, ?string $companyName = null, ?DefaultPayoutMethod $defaultPayoutMethod = null, ?string $paypalEmail = null, ?string $stripeConnectId = null, ?string $payoutsEnabledAt = null, ?string $identityVerifiedAt = null, ?string $tenantId = null, ?array $links = null, ?array $tags = null, ?string $description = null, ?string $groupId = null, ?string $clickRewardId = null, ?string $leadRewardId = null, ?string $saleRewardId = null, ?string $referralRewardId = null, ?string $discountId = null, ?string $applicationId = null, ?string $bannedAt = null, ?BannedReason $bannedReason = null, ?ReferralFormData $referralFormData = null, ?Application $application = null, ?float $earningsPerClick = null, ?float $averageLifetimeValue = null, ?float $clickToLeadRate = null, ?float $clickToConversionRate = null, ?float $leadToConversionRate = null, ?float $returnOnAdSpend = null, ?string $website = null, ?string $youtube = null, ?string $twitter = null, ?string $linkedin = null, ?string $instagram = null, ?string $tiktok = null, ?string $trustedAt = null, ?float $totalCommissions = 0, ?float $totalClicks = 0, ?float $totalLeads = 0, ?float $totalConversions = 0, ?float $totalSales = 0, ?float $totalSaleAmount = 0, ?float $netRevenue = 0)
    {
        ...
        $this->clickToConversionRate = $clickToConversionRate;
        $this->leadToConversionRate = $leadToConversionRate;
