...
class CreatePartnerRequestBody
{
     ...
     *
     * @var ?\Dub\Models\Operations\LinkProps $linkProps
     */
     ...
     * @param  ?\Dub\Models\Operations\LinkProps  $linkProps
     * @param  ?string  $name
     ...
     * @phpstan-pure
     */
    public function __construct(string $email, ?string $tenantId = null, ?string $groupId = null, ?LinkProps $linkProps = null, ?string $name = null, ?string $username = null, ?string $image = null, ?string $country = null, ?string $description = null)
    {
        $this->email = $email;
