...
class Link
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $domain, string $key, string $shortLink, string $url, ?string $partnerId = null, ?string $programId = null, ?string $tenantId = null, ?string $externalId = null)
    {
        $this->id = $id;
        $this->domain = $domain;
        $this->key = $key;
