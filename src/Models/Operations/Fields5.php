...
class Fields5
{
    ...
    /**
     *
     * @var \Dub\Models\Operations\CreatePartnerFieldsPartnersResponse201ApplicationJSONType $type
     */
     ...
     * @param  bool  $locked
     * @param  int  $position
     * @param  \Dub\Models\Operations\CreatePartnerFieldsPartnersResponse201ApplicationJSONType  $type
     * @phpstan-pure
     */
    public function __construct(string $key, string $label, bool $required, bool $locked, int $position, CreatePartnerFieldsPartnersResponse201ApplicationJSONType $type)
    {
        $this->key = $key;
        $this->label = $label;
