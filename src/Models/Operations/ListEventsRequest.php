...
class ListEventsRequest
{
     ...
     *
     * @var ?ListEventsQueryParamSortBy $sortBy
     */
    #[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortBy')]
    public ?ListEventsQueryParamSortBy $sortBy = null;
     ...
     * @param  ?ListEventsQueryParamSortBy  $sortBy
     * @param  ?Order  $order
