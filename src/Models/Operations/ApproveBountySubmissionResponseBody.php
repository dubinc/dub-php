...
class ApproveBountySubmissionResponseBody
{
     ...
     *
     * @var ApproveBountySubmissionStatus $status
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('status')]
    #[\Speakeasy\Serializer\Annotation\Type('\Dub\Models\Operations\ApproveBountySubmissionStatus')]
    public ApproveBountySubmissionStatus $status;
     ...
     *
     * @var ?array<ApproveBountySubmissionFiles> $files
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('files')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Dub\Models\Operations\ApproveBountySubmissionFiles>|null')]
    public ?array $files;
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $bountyId, string $partnerId, ApproveBountySubmissionStatus $status, string $createdAt, ?string $description = null, ?array $urls = null, ?array $files = null, ?float $performanceCount = null, ?int $socialMetricCount = null, ?string $completedAt = null, ?string $reviewedAt = null, ?string $rejectionReason = null, ?string $rejectionNote = null, ?string $socialMetricsLastSyncedAt = null)
    {
        $this->id = $id;
