...
class RejectBountySubmissionResponseBody
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $bountyId, string $partnerId, RejectBountySubmissionStatus $status, string $createdAt, ?string $description = null, ?array $urls = null, ?array $files = null, ?float $performanceCount = null, ?int $socialMetricCount = null, ?string $completedAt = null, ?string $reviewedAt = null, ?string $rejectionReason = null, ?string $rejectionNote = null, ?string $socialMetricsLastSyncedAt = null)
    {
        $this->id = $id;
