...
class CreatePartnerResponseBody
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $name, string $createdAt, CreatePartnerStatus $status, string $programId, ?string $email = null, ?string $image = null, ?string $country = null, ?string $website = null, ?string $youtube = null, ?string $twitter = null, ?string $linkedin = null, ?string $instagram = null, ?string $tiktok = null, ?string $paypalEmail = null, ?string $stripeConnectId = null, ?string $payoutsEnabledAt = null, ?string $tenantId = null, ?array $links = null, ?string $description = null, ?float $clicks = 0, ?float $leads = 0, ?float $sales = 0, ?float $saleAmount = 0, ?float $totalCommissions = 0, ?float $netRevenue = 0, ?float $earnings = 0)
    {
        $this->id = $id;
        $this->name = $name;
