...
class UpdateCustomerDiscount
{
    ...
    public UpdateCustomerType $type;
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, float $amount, UpdateCustomerType $type, bool $default, ?float $maxDuration = null, ?string $couponId = null, ?string $couponTestId = null, ?string $description = null, ?float $partnersCount = null)
    {
        $this->id = $id;
        $this->amount = $amount;
        $this->type = $type;
