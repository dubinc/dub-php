...
class ResponseBodyLink
{
     ...
     *
     * @var ?array<ListEventsResponseBodyTestVariants> $testVariants
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('testVariants')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Dub\Models\Operations\ListEventsResponseBodyTestVariants>|null')]
     ...
     * @param  ?string  $tagId
     * @param  ?array<ListEventsResponseBodyTestVariants>  $testVariants
     * @phpstan-pure
     */
