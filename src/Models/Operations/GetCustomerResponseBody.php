...
class GetCustomerResponseBody
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $name, string $externalId, string $createdAt, ?string $email = null, ?string $avatar = null, ?string $stripeCustomerId = null, ?string $country = null, ?float $sales = null, ?float $saleAmount = null, ?GetCustomerLink $link = null, ?string $programId = null, ?GetCustomerPartner $partner = null, ?GetCustomerDiscount $discount = null)
    {
        $this->id = $id;
        $this->name = $name;
