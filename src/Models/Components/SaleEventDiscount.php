...
class SaleEventDiscount
{
    ...
    /**
     *
     * @var SaleEventType $type
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('type')]
    #[\Speakeasy\Serializer\Annotation\Type('\Dub\Models\Components\SaleEventType')]
    public SaleEventType $type;
    ...
    /**
     *
     * @var ?SaleEventInterval $interval
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('interval')]
    #[\Speakeasy\Serializer\Annotation\Type('\Dub\Models\Components\SaleEventInterval|null')]
    public ?SaleEventInterval $interval;

    /**
     * @param  string  $id
     * @param  float  $amount
     * @param  SaleEventType  $type
