...
class AnalyticsCountries
{
    ...
    /**
     *
     * @var ?\Dub\Models\Components\Region $region
     */
    ...
    /**
     *
     * @var ?\Dub\Models\Components\City $city
     */
     ...
     * @param  ?\Dub\Models\Components\Region  $region
     * @param  ?\Dub\Models\Components\City  $city
     * @param  ?float  $clicks
     * @param  ?float  $leads
     * @param  ?float  $sales
     ...
     * @phpstan-pure
     */
    public function __construct(string $country, ?Region $region = Region::Wildcard, ?City $city = City::Wildcard, ?float $clicks = 0, ?float $leads = 0, ?float $sales = 0, ?float $saleAmount = 0)
    {
