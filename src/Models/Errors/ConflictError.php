...
class ConflictError
{
    ...
    #[\JMS\Serializer\Annotation\Type('\Dub\Models\Errors\ConflictCode')]
     ...
     * @param  ?string  $docUrl
     */
    public function __construct(?ConflictCode $code = null, ?string $message = null, ?string $docUrl = null)
    {
        $this->code = $code;
