...
class UnauthorizedError
{
    ...
    #[\JMS\Serializer\Annotation\Type('\Dub\Models\Errors\UnauthorizedCode')]
     ...
     * @param  ?string  $docUrl
     */
    public function __construct(?UnauthorizedCode $code = null, ?string $message = null, ?string $docUrl = null)
    {
        $this->code = $code;
