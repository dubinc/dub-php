...
class Analytics
{
    ...
    public function retrieve(
        ...
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\Dub\Models\Operations\RetrieveAnalyticsRequest::class, $request, $this->sdkConfiguration->globals));
