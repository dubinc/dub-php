...
class Customers
{
    ...
    public function create(?Operations\CreateCustomerRequestBody $request = null, ?Options $options = null): Operations\CreateCustomerResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'createCustomer', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $id, ?Options $options = null): Operations\DeleteCustomerResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'deleteCustomer', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function get(string $id, ?bool $includeExpandedFields = null, ?Options $options = null): Operations\GetCustomerResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'getCustomer', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function list(?string $email = null, ?string $externalId = null, ?bool $includeExpandedFields = null, ?Options $options = null): Operations\GetCustomersResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($baseUrl, 'getCustomers', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
    ...
    public function update(Operations\UpdateCustomerRequest $request, ?Options $options = null): Operations\UpdateCustomerResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'updateCustomer', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
